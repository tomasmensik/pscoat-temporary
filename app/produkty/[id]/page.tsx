...
export default function ProductDetailPage() {
  ...
  return (
    <>
      <main className="w-full min-h-screen bg-gradient-to-b from-gray-50 to-white">
        {/* Header */}
        <section className="bg-gradient-to-br from-[#0180ae] to-[#00a4d6] text-white py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="max-w-3xl">
              ...
              <div className="inline-block px-4 py-2 bg-white/20 rounded-full text-sm font-medium backdrop-blur">
                {category.name}
              </div>
            </div>
          </div>
