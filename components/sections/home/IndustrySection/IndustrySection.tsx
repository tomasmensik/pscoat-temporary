...
import { useIconContent } from "./data";
import { clamp } from "./utils";
import { useSliderAnimation, useDragHandlers } from "./hooks";
...
export default function IndustrySection() {
  ...
  const iconContent = useIconContent();
                ...
                <div className="col-span-12 text-white text-center lg:text-left pt-8 sm:pt-10 lg:pt-0">
                  ...
                  <div className="flex justify-center lg:justify-start">
                    <Button
                      variant="ghost"
                      size="md"
                      className="mb-8 md:mb-0 lg:mb-0"
                    >
                      {t("industry.button")}
                    </Button>
                  </div>
            ...
            <div className="grid grid-cols-12 gap-4 lg:gap-8 items-start">
              ...
              <div className="hidden lg:block lg:col-span-2 pt-[15vh] pb-[15vh]">
                <div className="relative h-[70vh] w-full">
                  ...
                  >
                    <ArrowUpIcon className="w-5 h-5 lg:w-6 lg:h-6 text-white" />
                  </button>
              ...
              <div className="col-span-12 lg:col-span-10 relative flex flex-col items-center justify-center w-full pt-2 pb-10 lg:py-[15vh]">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <DoubleArrowIcon className="w-5 h-5 text-gray-800" />
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex flex-col items-center justify-center gap-6 lg:flex-row">
                    ...
                    <div className="flex flex-col gap-1">
                      {iconContent[selectedIcon].bullets.map((bullet, idx) => (
                        ...
                        >
                          <ChevronBulletIcon className="w-4 h-4 text-white opacity-80" />
                          <span>{bullet}</span>
                        </p>
                      ))}
                    </div>
